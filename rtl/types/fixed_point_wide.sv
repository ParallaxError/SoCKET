/*
 * @file /rtl/types/fixed_point_wide.sv
 * @brief
...
`ifndef FIXED_POINT_WIDE__PKG_SV
`define FIXED_POINT_WIDE__PKG_SV
...
package fixed_point_wide_pkg;
    ...
    typedef struct packed {
        logic signed [FIXED_WIDTH*2-1:0] value;
    } fixed_wide_t;
...
endpackage
`endif // FIXED_POINT_WIDE__PKG_SV